        ...
        try {
            ...
            String prompt =
                    "이 이미지는 약봉투 또는 처방 관련 이미지다.\n" +
                            ...
                            "}\n" +
                            "규칙:\n" +
                            "1. rawText에는 다음 정보를 반드시 포함하라:\n" +
                            "   - 약품명\n" +
                            "   - 복용 기간 (예: 3일분, 5일치)\n" +
                            "   - 복용 횟수 (예: 1회 2정, 하루 3회)\n" +
                            "   - 복용 시간 (예: 아침, 점심, 저녁, 취침 전)\n" +
                            "2. drugCandidates에는 약품명처럼 보이는 항목만 넣을 것.\n" +
                            "3. 병원명, 조제문구, 전화번호, 날짜(처방일)는 rawText에서 제외할 것.\n" +
                            "4. JSON 외 다른 설명은 절대 쓰지 말 것.";
