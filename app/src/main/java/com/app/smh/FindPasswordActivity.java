...
public class FindPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btnBack = findViewById(R.id.btn_back_find_password);
        EditText etEmail = findViewById(R.id.et_find_password_email);
        EditText etCode = findViewById(R.id.et_find_password_code);
        btnSendCode = findViewById(R.id.btn_find_password_send_code);
        btnVerifyCode = findViewById(R.id.btn_find_password_verify_code);
        TextView tvCodeTimer = findViewById(R.id.tv_find_password_code_timer);
                        ...
                        runOnUiThread(() -> {
                            if (response != null && response.verified) {
                                ...
                                startActivity(new Intent(this, ResetPasswordActivity.class)
                                        .putExtra("verifyToken", response.verifyToken)
